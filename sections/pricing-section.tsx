            ...
            <div className="p-4 pt-20 flex flex-col items-center max-w-7xl mx-auto justify-center border-x border-gray-200">
                ...
                <div className="flex flex-wrap items-start justify-center gap-10 md:gap-4 px-4 mt-12">
                    {pricing.map((plan, index) => (
                        <AnimatedContent delay={index * 0.05} key={index} className={`p-5 pb-8 w-full sm:max-w-64 rounded-xl border border-gray-200 ${plan.type === 'enterprise' ? 'bg-orange-500 text-white' : plan.type === 'popular' ? 'bg-linear-to-br from-orange-50 to-orange-100' : 'bg-white'}`}>
