...
export default function MembershipSection() {
    ...
    return (
        <section className="relative bg-[url('/assets/hero-gradient-bg.png')] bg-cover bg-center bg-no-repeat px-4 md:px-16 lg:px-24 xl:px-32 border-b border-gray-200 overflow-hidden">
            <div className="absolute inset-0 bg-[url('/assets/bg2.webp')] bg-cover bg-center bg-no-repeat opacity-30" style={{ zIndex: 0 }}></div>
            <div className="relative p-4 pt-20 pb-24 md:p-20 flex flex-col items-center max-w-7xl mx-auto justify-center border-x border-gray-200" style={{ zIndex: 1 }}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16 w-full max-w-5xl">
                    <AnimatedContent delay={0.04} distance={0} className="flex flex-col items-center text-center p-6 rounded-xl bg-white/70 border border-white">
                    ...
                    <AnimatedContent delay={0.08} distance={0} className="flex flex-col items-center text-center p-6 rounded-xl bg-white/70 border border-white">
                        <div className="p-3 rounded-lg mb-4" style={{ backgroundColor: '#762727' }}>
                    ...
                    <AnimatedContent delay={0.12} distance={0} className="flex flex-col items-center text-center p-6 rounded-xl bg-white/70 border border-white">
                        <div className="p-3 rounded-lg mb-4" style={{ backgroundColor: '#762727' }}>
                ...
                <AnimatedContent delay={0.16} distance={0} className="mt-16 text-center">
                    ...
                    <Link 
                        ...
                        className="py-3 md:py-2.5 px-8 border text-white text-center rounded-full transition-transform duration-200 hover:scale-105"
